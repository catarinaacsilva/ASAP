""" 
Script to obtain information pretaining to the quality of the models' analysis quality.
"""
...
def plot_agreement_rates(agreement_percentage_list):
    """
    Create a plot of how often X models agree with each other.
    The final image is stored in `out/analysis_model_consensus_plot.png`

    Parameters
    ----------
    agreement_percentage_list: A list of percentages (from 0 to 1) of models agreeing on whether an APK is malicious or not.
    """
    counts = Counter(agreement_percentage_list)
...
def main():
    """
    Read datasets and analysis results to determine how often the models agree with each other on whether an APK is malicious.
    Produce an image with this data and also print the results to stdout.
    """
    ...
    for fname in glob.glob("out/apk_analysis_*.json"):
        ...
        plot_agreement_rates(model_consensus)
